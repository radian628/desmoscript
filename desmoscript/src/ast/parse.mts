...
import {
  ...
  MacroDefinitionExprContext,
  MatchExprContext,
  MemberAccessExprContext,
  MultOrDivExprContext,
  NamedJsonExprContext,
  NamespaceDefinitionExprContext,
  NullDJsonContext,
  NumberDJsonContext,
  NumberExprContext,
  ObjectDJsonContext,
...
} from "../grammar/DesmoscriptParser";
...
export class DesmoscriptASTBuilder
  ...
  implements DesmoscriptVisitor<ds.ASTExpr>
{
  filename: string;
  ...
  visitSumProdIntegralExpr(ctx: SumProdIntegralExprContext): ds.ASTExpr {
    return this.withLineCol<ds.ASTSumProdInt<{}>>(ctx, {
      ...
      body: this.visit(ctx._body),
      opType: (ctx._op.text ?? "sum") as PropType<
        ds.ASTSumProdInt<{}>,
        "opType"
      >,
    });
  ...
  visitNamespaceDefinitionExpr(
    ctx: NamespaceDefinitionExprContext
  ): ds.ASTExpr {
  ...
  visitMatchExpr(ctx: MatchExprContext): ds.ASTExpr {
    return this.withLineCol<ds.ASTMatch<{}>>(ctx, {
      branches: ctx._predicate.map(
        (e, i) =>
          [this.visit(e), this.visit(ctx._result[i])] as [
            ds.ASTExpr,
            ds.ASTExpr
          ]
      ),
  ...
  visitArrayDJson(ctx: ArrayDJsonContext): ds.ASTExpr {
    const children: ds.ASTJSON<{}>[] = ctx._elements.map(
      (elem) => this.visit(elem) as ds.ASTJSON<{}>
    );
  ...
  visitDesmoscriptDJson(ctx: DesmoscriptDJsonContext): ds.ASTExpr {
    //console.log("got here Desmoscript DJson!");
    return this.withLineCol<ds.ASTJSON<{}>>(ctx, {
      type: ds.ASTType.JSON,
      data: {
  ...
  visitStringExpr(ctx: StringExprContext): ds.ASTExpr {
    return this.withLineCol<ds.ASTNote<{}>>(ctx, {
      type: ds.ASTType.NOTE,
