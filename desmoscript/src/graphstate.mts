...
export const expressionStateWithoutColumnParser = z.object({
    ...
    editableLabelMode: z.union([
        z.literal("MATH"), z.literal("TEXT")
    ]).optional(),
    ...
    vizProps: z.object({
        ...
        alignedAxis: z.union([
            z.literal("x"), z.literal("y")
        ]).optional(),
        showBoxplotOutliers: z.boolean().optional(),
        dotplotXMode: z.union([
            z.literal("exact"), z.literal("binned")
        ]).optional(),
        binAlignment: z.union([
            z.literal("left"), z.literal("center")
        ]).optional(),
        histogramMode: z.union([
            z.literal("count"), 
            z.literal("relative"),
            z.literal("density"),
        ]).optional(),
...
export const expressionStateParser = expressionStateWithoutColumnParser
    .merge(columnExpressionSharedParser);
...
export const imageStateParser = z.object({
    ...
    clickableInfo: z.intersection(baseClickableParser,
        z.object({
...
export const tableStateParser = z.intersection(baseNonFolderStateParser,
    z.object({
...
export const GrapherStateParser = z.object({
    viewport: z.object({
        xmin: z.number(),
        ymin: z.number(),
        xmax: z.number(),
